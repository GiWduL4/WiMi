...
\coordinate (arrowstart) at (13,29.8);
\coordinate (corner) at (40,35);

\draw[style=very thick](arrowstart) -- (corner);

\draw[style=very thick, ->](corner) -- (focus);
...
\node at (60,18){\scriptsize{gravity}};
...
\node[text width=60] at (35,20){Crossed \\ Dipole-Trap};
