...
\fill[color = red, opacity = 0.7] (BO2) -- (BO1) -- (Chamber1) -- (Chamber2) -- cycle;
...
\path (chamber) + (\angB:17) coordinate (POcam);
\coordinate (camtest) at (82.5, 44.5);	
\mirror{POcam}{camtest}{4.0}{4*\w};
\cameraT{camtest}{POcam}{4*\w};
	\node at (87,40){\tiny{TK}};
